...
// Announcement banner: cross-fades between up to 3 slides (generated by
// generate_cms_sections.py from content/announcement.json) instead of the
// old continuously-scrolling ticker. No prev/next controls - it only ever
// advances on its own. A single real message is duplicated by the
// generator into two identical slides so this still visibly cycles
// (fade + slight rise) instead of sitting static.
(function(){
